...
import User from './backend/src/features/users/models/User.js';
import Category from './backend/src/features/categories/models/Category.js';
import Product from './backend/src/features/products/models/Product.js';
import Order from './backend/src/features/orders/models/Order.js';
...
console.log('Using MONGO_URI:', mongoUri ? `${mongoUri.substring(0, 30)}...` : 'undefined');
